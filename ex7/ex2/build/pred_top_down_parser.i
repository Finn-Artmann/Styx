# 0 "src/pred_top_down_parser.c"
# 1 "/home/finn/Documents/OTH/CC/CompilerConstruction/ex7/ex2//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/pred_top_down_parser.c"
...
# 2 "src/pred_top_down_parser.c" 2
...
# 3 "src/pred_top_down_parser.c" 2
...
# 4 "src/pred_top_down_parser.c" 2
...
# 5 "src/pred_top_down_parser.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stdbool.h" 1 3 4
# 6 "src/pred_top_down_parser.c" 2




# 9 "src/pred_top_down_parser.c"
typedef int val_t;
typedef struct {
  val_t *val;
  int size;
...
# 74 "src/pred_top_down_parser.c" 3 4
_Bool 
# 74 "src/pred_top_down_parser.c"
    is_terminal (char ch) {
...
# 171 "src/pred_top_down_parser.c"
